...
# ALGORITHM:
1. STEP 1:Read the given Data.
2. STEP 2:Clean the Data Set using Data Cleaning Process.
3. STEP 3:Apply Feature Scaling for the feature in the data set.
4. STEP 4:Apply Feature Selection for the feature in the data set.
5. STEP 5:Save the data to the file.
